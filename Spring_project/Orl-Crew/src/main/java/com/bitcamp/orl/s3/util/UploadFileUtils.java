package com.bitcamp.orl.s3.util;
...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath, String originalName, String contentType, byte[] byteData) throws Exception {
		S3Util s3 = new S3Util();
		
		///////////////////////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////////
		String bucketName = "버킷 네임";
		///////////////////////////////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////////
		...
		s3.fileUpload(bucketName, uploadPath + uploadedFileName, metaData, byteData);
